...
#include	"rtty-bandfilter.h"
	...
	rttyBandfilter::rttyBandfilter (int16_t firSize,
...
//	windowing, according to Blackman
	...
	rttyBandfilter::~rttyBandfilter () {
}

std::complex<float>
	rttyBandfilter::Pass (std::complex<float> z) {
int16_t	i;
...
void	rttyBandfilter::update	(int shift, int width) {
	(void)width;
